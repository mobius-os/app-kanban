"""SSRF-safe transport for Kanban collaboration's outbound requests.

Kanban accepts peer locations from invitations and membership records. Every
outbound Kanban request therefore crosses this one boundary: resolve and
validate all addresses against the app's public-address policy, connect to that exact address,
